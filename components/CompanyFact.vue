    ...
    <section class="py-14 dark:!bg-none lg:py-[100px]"
        ...
        <div class="container mx-auto px-4 md:px-0">
            <div class="heading text-center">
                <h6>Company Facts</h6>
                <h4 class="text-white">We are proud of our team</h4>
            </div>
           <ProudTeam />
        </div>
        <div
            ...
            <div class="container mx-auto">
                <div class="  items-end gap-6 lg:flex xl:gap-0 px-4 md:px-0">
                    <div class="lg:w-1/2">
                        <div class="heading mb-16 text-center lg:text-left ">
                            <h6>What Makes us Different?</h6>
                            <h4 class="leading-normal !text-white lg:!leading-[50px]">We bring solutions to make life
                                easier for our customers.</h4>
                        </div>
                        <div class="grid gap-x-7 gap-y-12 sm:grid-cols-2 aos-init" data-aos="fade-right"
                    ...
                    <div class=" mx-auto mt-10  md:w-[45%] lg:mt-0 ">
                        <img src="../assets/images/box-img.png" alt="box-img" class="w-full rotate-y-180">
                    </div>
                </div>
            </div>
        </div>
