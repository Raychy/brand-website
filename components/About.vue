<template>
     <div class="container ">
          ...
          <div class=" mx-auto grid gap-[30px] sm:grid-cols-2 lg:grid-cols-4">
              <div data-aos="fade-up" data-aos-duration="1000" class="aos-init aos-animate">
                  <div class="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-purple hover:bg-purple/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-purple">
                      <div>
                          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-purple transition dark:group-hover:text-black">
                      ...
                      <div class="ltr:pl-4 pr-4">
                          <h4 class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black" data-vanilla-counter="" data-start-at="0" data-end-at="10" data-time="4000" data-delay="1000" data-format="{}+">10+</h4>
              ...
              <div data-aos="fade-up" data-aos-duration="1000" class="aos-init aos-animate">
                  <div class="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-purple hover:bg-purple/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-purple">
                      ...
                      <div class="ltr:pl-4 pr-4">
                          <h4 class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black" data-vanilla-counter="" data-start-at="0" data-end-at="120" data-time="4000" data-delay="1000" data-format="{}+">120+</h4>
              ...
              <div data-aos="fade-up" data-aos-duration="1000" class="aos-init aos-animate">
                  <div class="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-purple hover:bg-purple/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-purple">
                      ...
                      <div class="ltr:pl-4 pr-4">
                          <h4 class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black" data-vanilla-counter="" data-start-at="0" data-end-at="350" data-time="4000" data-delay="1000" data-format="{}+">350+</h4>
                          <span class="font-bold text-black transition dark:text-gray dark:group-hover:text-black">Happy Clients</span>
                      </div>
                  </div>
              </div>
              <div data-aos="fade-up" data-aos-duration="1000" class="aos-init aos-animate">
                  <div class="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-purple hover:bg-purple/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                      <div>
                      ...
                      <div class="ltr:pl-4 pr-4">
                          <h4 class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black" data-vanilla-counter="" data-start-at="0" data-end-at="1254" data-time="4000" data-delay="1000" data-format="{}+">1254+</h4>
