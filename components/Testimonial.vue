<template>
    <section class="relative dark:bg-gray-dark py-14 dark:bg-transparent lg:py-[100px]">

        <div class="w-[100px]" style="width:200px">

        </div>
        <div class="absolute top-0 right-0 left-0">
            <svg width="758" height="741" viewBox="0 0 758 741" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.03">
                    <ellipse opacity="0.1" cx="752" cy="370.646" rx="750" ry="749.646" stroke="white" stroke-width="3"
                        stroke-miterlimit="4.62023" stroke-linecap="round" stroke-dasharray="35 50 15 15"></ellipse>
                    <path opacity="0.1"
                    ...
                    <ellipse opacity="0.2" cx="752" cy="370.646" rx="634.561" ry="634.207" stroke="white"
                        ...
                        stroke-dasharray="35 50 15 15"></ellipse>
                    <path opacity="0.3"
        ...
        <div class="container">
            ...
            <div class="mx-auto lg:w-11/12">
                <div
                    ...
                    <Carousel  ref="carousel"  :settings="settings" data-swiper-slide-index="0" role="group" aria-label="1 / 2" class="md:mr-20">
                        <slide v-for="a in 5" :key="a" class=" ">
                            <div class="items-center gap-10 sm:grid sm:grid-cols-3">
                                <div class="col-span-2">
                                    <div class="relative rounded-3xl bg-white/[0.03] p-6">
                                        <img src="../assets/images/blue-quote.png" alt="blue-quote"
                                            class="absolute top-0 sm:-top-6 sm:-right-6 ">
                                        <div class="pb-8">
                                        ...
                                        <p class="relative font-medium italic text-white text-left">
                                        ...
                                        <div class="mt-12">
                                            <h5 class="font-extrabold text-blue text-left">Allan Branch </h5>
                                            <h6 class="text-sm font-bold italic text-left">CEO of Lifted</h6>
                                        </div>
                                    </div>
                                </div>
                                <img src="../assets/images/testimonial.png" alt="testimonial"
                                    class="mx-auto mt-4 h-20 w-20 rounded-full object-cover object-top ml-auto mr-auto sm:mt-0 sm:h-auto sm:w-auto sm:rounded-[150px] sm:object-scale-down sm:mr-0 sm:ml-0">
                            </div>
                        </slide>
                    </Carousel>
                    <div
                    class="bottom-0 z-[1] mt-5 flex items-center justify-center gap-4 right-1/3 left-1/3 sm:absolute sm:mt-0 sm:justify-end">
                    <NuxtLink to="/porfolio"
                        class="text-sm font-extrabold text-white transition hover:text-purple dark:hover:text-purple">
                        View All</NuxtLink>
                    <button type="button" @click="next()"
                        ...
                        tabindex="0" aria-label="Previous slide" aria-controls="swiper-wrapper-335b64babc6c9fb4">
