<template>
     <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3  mt-10"  data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out-cubic">
          <div class="group rounded-3xl border-2 border-white bg-white p-6 transition duration-500 hover:border-blue hover:bg-blue/20 dark:border-white/10 dark:bg-cyberbizkit-dark dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-blue"
               style="box-shadow: -20px 30px 70px rgba(219, 222, 225, 0.4)">
               <div class="flex h-14 w-14 items-center justify-center rounded-full bg-purple transition group-hover:bg-black"
               ...
               <NuxtLink to="/"
                    class="my-8 inline-block text-[22px] font-extrabold text-black dark:text-white dark:group-hover:text-black">UI/UX
                    Design</NuxtLink>
               <p
                    class="mb-10 text-lg font-semibold transition line-clamp-3 dark:group-hover:text-black text-light-purple2">
                    We provide services with the best designs than our designer team for your
                    business.
               </p>
               <NuxtLink to="/"
                    class="flex h-11 w-11 items-center justify-center rounded-full bg-light-black transition group-hover:bg-black rotate-180 dark:bg-gray-dark">
