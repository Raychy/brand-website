<template>
    <div>
        <footer
            class="bg-white py-14 dark:bg-black2 dark:bg-gradient-to-b dark:from-white/[0.03] dark:to-black2 lg:py-[100px]">
                ...
                <div class="grid gap-y-10 gap-x-4 sm:grid-cols-3 lg:grid-cols-5">
                            ...
                            <li>
                                <NuxtLink to="/">
                                    <svg width="10" height="20" viewBox="0 0 10 20" fill="none"
                                        ...
                                        class="transition hover:scale-110 hover:text-purple">
                                        <path
                    ...
                    <div>
                        <ul class="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Home
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">
                                    Portfolio</NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Team
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">About
                                    Us</NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Career
                                </NuxtLink>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">UI/UX
                                    Design</NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Web
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">App
                                    Development</NuxtLink>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Terms
                                    &amp; Conditions</NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">FAQs
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">Blog
                                </NuxtLink>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="flex flex-col gap-3 font-bold">
                            ...
                            <li>
                                <NuxtLink to="" class="inline-block transition hover:scale-110 hover:text-purple">+(617)
                                    254-2333</NuxtLink>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="py-5 dark:border-t-2 dark:border-white/5">
            <div class="container">
                <div class="items-center justify-between text-center font-bold dark:text-white md:flex">
                    <div>
                        Copyright© {{ new Date().getFullYear() }} <NuxtLink to="" class="text-blue transition hover:text-purple">
                            Cyberbizkit</NuxtLink>
                    </div>
                    <div>Need help? Visit the <NuxtLink to="" class="text-purple transition hover:text-blue">Contact Us
                        </NuxtLink>
                    </div>
                </div>
            </div>
