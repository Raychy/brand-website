<template>
     <header class="sticky top-0 z-50 border-b-2 border-white/5 bg-black">
          <div class="container">
                    ...
                    <div class="flex items-center">
                              ...
                              <ul>
                                   ...
                                   <li class="group relative">
                                        <NuxtLink to="/health">
                                             Landing
                                             <div
                                                  class="transition duration-500 group-hover:rotate-180 ml-2 mr-2">
                                        ...
                                        <div class="submenu  bg-cyberbizkit-light dark:bg-cyberbizkit-dark ">
                                             <NuxtLink to="/" class="dark:text-white">Crypto Currency</NuxtLink>
                                             <NuxtLink to="/" class="dark:text-white">
                                                  Sales Marketing
                                                  <span
                                                       class="ml-1 rounded bg-purple px-2 py-1 text-[9px] font-bold uppercase text-white">Coming
                                                       Soon</span>
                                             </NuxtLink>
                                             <NuxtLink to="/" class="dark:text-white">
                                                  Health Care
                                   ...
                                   <li
                                        class="relative hidden items-center before:absolute before:top-1/2 before:h-[30px] before:w-[2px] before:-translate-y-1/2 before:bg-gray/30 pl-9 before:-left-[2px] pr-9 before:-right-[2px] lg:inline-flex">
                                        <button type="button" onclick="search()" class="text-white hover:text-blue">
                                   ...
                                   <li
                                        class="search-bar absolute hidden w-0 overflow-hidden bg-black transition-all duration-500 right-0 left-0 lg:block">
                                        <form action="" class="relative">
                                             <input type="text" placeholder="Search"
                                                  class="w-full border-b border-white bg-transparent py-1 outline-none pl-2 pr-2 ">
                                             <button type="button"
                                                  class="absolute top-1/2 -translate-y-1/2 hover:text-blue right-0 left-0"
                                                  onclick="search()">
                              ...
                              <li>
                                   <button type="button"
                                        ...
                                        <svg width="17" height="22" viewBox="0 0 17 22" fill="none"
                                             ...
                                             <path d="M12.7855 1H5.82118C4.82662 1 3.87279 1.37909 3.16952 2.05387C2.46626 2.72865 2.07117 3.64385 2.07117 4.59813C2.07117 5.55242 2.46626 6.46761 3.16952 7.14239C3.87279 7.81717 4.82662 8.19626 5.82118 8.19626H6.3569"
                              ...
                              <li>
                                   <button type="button"
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                             ...
                                             <path d="M8 4C8 8.4 11.6 12 16 12C17.4 12 18.8 11.6 20 11C19.5 16.1 15.2 20 10 20C4.5 20 0 15.5 0 10C0 4.8 4 0.5 9 0C8.4 1.2 8 2.6 8 4ZM2 10C2 14.4 5.6 18 10 18C12.9 18 15.5 16.5 17 14C16.7 14 16.4 14 16 14C10.5 14 6 9.5 6 4C6 3.7 6 3.4 6 3C3.6 4.4 2 7.1 2 10Z"
                                                  fill="currentColor"></path>
                                        </svg>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                         ...
                         <button type="button"
                              ...
                              <svg width="22" height="18" viewBox="0 0 22 18" fill="none"
                                   ...
                                   <path d="M2 15H11C11.552 15 12 15.447 12 16C12 16.553 11.552 17 11 17H2C1.448 17 1 16.553 1 16C1 15.447 1.448 15 2 15Z"
                                        fill="currentColor"></path>
                                   <path d="M2 8H20C20.552 8 21 8.447 21 9C21 9.553 20.552 10 20 10H2C1.448 10 1 9.553 1 9C1 8.447 1.448 8 2 8Z"
                                        fill="currentColor"></path>
