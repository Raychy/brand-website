          ...
          <section class="py-14 dark:bg-gray-dark lg:py-[100px]">
               <div class="container">
                   <div class="relative z-10 lg:flex">
                       <div class="heading text-center lg:mb-0 lg:w-1/3 lg:pr-10 lg:text-left lg:pl-10 ">
                           <h6>Get In Touch.</h6>
                           <h4 class="sm:!leading-[50px] dark:text-white">Ready to Get Started?</h4>
                           <img src="../assets/images/form-img.png" alt="form-img" class="mx-auto aos-init" data-aos="fade-right" data-aos-duration="1000">
                       </div>
                       <form action="" class="rounded-3xl bg-white px-4 py-12 dark:bg-[#101626] lg:w-2/3 lg:px-8">
                           <div class="grid gap-10 sm:grid-cols-2">
                               <div class="relative">
                                   <input type="text" name="name" class="w-full rounded-2xl border-2 border-light-purple2/20 bg-[#101626] p-4 font-bold outline-none transition focus:border-purple pr-12 pl-12">
                                   <label for="" class="absolute -top-3 bg-white px-2 font-bold left-6 dark:bg-[#101626] dark:text-white">Full Name</label>
                                   <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 -translate-y-1/2 right-4 left-4 dark:text-white">
                               ...
                               <div class="relative">
                                   <input type="email" name="email" class="w-full rounded-2xl border-2 border-light-purple2/20 bg-[#101626] p-4 font-bold outline-none transition focus:border-purple pr-12 pl-12">
                                   <label for="" class="absolute -top-3 bg-white px-2 font-bold left-6  dark:bg-[#101626] dark:text-white">Email Address</label>
                                   <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 -translate-y-1/2 right-4 left-4 dark:text-white">
                               ...
                               <div class="relative">
                                   <input type="text" name="mobile" class="w-full rounded-2xl border-2 border-light-purple2/20 bg-[#101626] p-4 font-bold outline-none transition focus:border-purple pr-12 pl-12">
                                   <label for="" class="absolute -top-3 bg-white px-2 font-bold left-6  dark:bg-[#101626] dark:text-white">Mobile Number</label>
                                   <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 -translate-y-1/2 right-4 left-4 dark:text-white">
                               ...
                               <div class="relative">
                                   <input type="text" name="city" class="w-full rounded-2xl border-2 border-light-purple2/20 bg-[#101626] p-4 font-bold outline-none transition focus:border-purple pr-12 pl-12">
                                   <label for="" class="absolute -top-3 bg-white px-2 font-bold left-6  dark:bg-[#101626] dark:text-white">City</label>
                                   <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 -translate-y-1/2 right-4 left-4 dark:text-white">
                           ...
                           <div class="relative mt-10">
                               <input type="text" name="message" class="w-full rounded-2xl border-2 border-light-purple2/20 bg-[#101626] p-4 font-bold outline-none transition focus:border-purple pr-12 pl-12">
                               <label for="" class="absolute -top-3 bg-white px-2 font-bold left-6  dark:bg-[#101626] dark:text-white">Message</label>
                               <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 -translate-y-1/2 right-4 left-4 dark:text-white">
                           ...
                           <div class="mt-10 text-center lg:text-right ">
                               <button type="button" class="btn bg-gray px-12 capitalize text-white dark:bg-white dark:text-black dark:hover:bg-purple">
                                   Send Message
                               </button>
                           </div>
                       </form>
